...
public class clsRemove {
    ...
    clsRemoveSolution getRemoveSolution()
    {
        ...
        for( i=0;i<RemoveList.size();i++){
            ...
            if(VisitIndex==0){
                UnusedTimeAtTheStartOfTheTour=clsGeneral.getTourUnusedTimeAtTheStart(solution.Itinerary[TourIndex][VisitIndex+1].POI_ID);
            }
            int TourLastVisit=solution.TourLastVisit[1][TourIndex];
            ShiftingValue=this.getShiftingValue(TourIndex, VisitIndex,TourLastVisit,
        ...
        if(i==RemoveList.size())
        {
            ...
            int lastVisitIndex=solution.TourLastVisit[1][randomTourIndex];
                ...
                ShiftingValue=this.getShiftingValue(randomTourIndex, lastVisitIndex, lastVisitIndex,
        ...
        result.DistanceFromPreviousPointToNextPoint=this.getDistanceFromPreviousPointToNextPoint(result.TourIndex, result.VisitIndex);
        result.UnusedTimeAtTheStartOfTheTour=UnusedTimeAtTheStartOfTheTour;
        return result;
    }

    float getDistanceFromPreviousPointToNextPoint(int TourIndex, int VisitIndex){
        float result;
        if(VisitIndex==0){           
...
//    }
    ...
    float getShiftingValue(int TourIndex, int VisitIndex,int TourLastVisit,
